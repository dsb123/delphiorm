...
unit uOracleSQLStatementManager;
...
type
  TOracleSQLStatementManager = class(TSQLStatementManager)
  public
...
function TOracleSQLStatementManager.EjecutarDelete(
...
function TOracleSQLStatementManager.EjecutarInsert(
...
function TOracleSQLStatementManager.EjecutarSelect(
...
function TOracleSQLStatementManager.EjecutarUpdate(
